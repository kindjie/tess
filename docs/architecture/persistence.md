...
reject pre-load derived state. Every loaded chunk receives a full-chunk
topology invalidation; the caller supplies the dirty mask. Derived state must be
rebuilt against the loaded authoritative fields.
