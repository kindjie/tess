# Design Changelog (Archive, June 2026)

Archived design-changelog entries from June 2026. The live changelog is
[`CHANGELOG.md`](CHANGELOG.md); newer archived entries are in
[`CHANGELOG-archive.md`](CHANGELOG-archive.md). Entries below are in
reverse-chronological order as they were written.
