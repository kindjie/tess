# Design Changelog Archive (2026-07-28 to 2026-08-19)

Entries moved from `CHANGELOG.md` when it approached the 24k-token
file limit. Newer entries remain in the live changelog; older archives
