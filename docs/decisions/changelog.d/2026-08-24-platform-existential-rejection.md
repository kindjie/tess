...
the second leg cannot change the verdict. The P3, P4, and P5
pre-registrations each declared this refinement before their data
("platform-existential rule"), their reviews accepted it, and the
screens applied it. A pre-RC audit flagged the surviving contradiction
