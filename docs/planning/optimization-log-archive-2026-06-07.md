# Optimization Log Archive (2026-06 through 2026-07-12)

Entries moved verbatim from [`optimization-log.md`](optimization-log.md) when
that file approached the repository's 24,000-token file limit. Same
conventions: area and date, hypothesis, evidence, decision, retry conditions.
