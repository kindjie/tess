...
the candidate is harmful (gm 1.0154; ring 1.0924): with no goal surplus
the policy can only exchange, and exchange churn slows settling. The
...
[1.4103, 1.5411]): the anonymous-pool advantage overwhelmingly lives in
...
assignment validity, deterministic replay.
