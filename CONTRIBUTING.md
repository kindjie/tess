...
3. **Profile and diff.** Build both revisions under the
   ...
   concluding anything.
4. **Record.** Accepted, rejected, and inconclusive outcomes all go
   to `docs/planning/optimization-log.md` — inconclusive entries stop
   the next contributor from repeating the dead end.
