...
// Planner reuse: the plan_operations overload that
...
TEST(TessQueuedPlanning, WarmPlanningReuseIsAllocationFree) {
  ...
  (void)ops.update_field(
      tess::DomainDesc::dirty_chunks(DirtyCost),
      tess::FieldAccessDesc{DirtyCost.value, 0, tess::DirtyMask{}},
