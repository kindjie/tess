...
- `tess_pibt_movement_test`: pins PIBT priority inheritance, backtracking,
  occupancy, swap, determinism, and warm-allocation contracts through the real
  weighted tick driver. The 64x64, 48-agent ring gate is a load-bearing
  contrast:
