...
- The substrate test pins a deterministic 18-seed subset (trials 0-1
  per family plus every divergent seed) to honor the 60-second per-test
  contract; the full 132-seed sweep is evidence, captured with its
