...
- `tests/test_branding_assets.py`: static asset and browser-demo contract
  ...
  occupied wall tiles, separate wall- and crowd-blocked outcomes, bounded
  recovery and whole-wave turnaround, movement diagnostics, optional
  congestion-triggered route spreading, the comparison article's scoped
  algorithm/strategy status contract, and maintained model/native/Wasm seams.
  It also covers documentation navigation, dependencies, licensing,
  accessibility, readiness, and browser-smoke contracts. Assertions
