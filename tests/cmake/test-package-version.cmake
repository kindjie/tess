...
function(make_package name version prerelease compatibility)
  ...
  file(WRITE "${package_dir}/tess-config.cmake"
...
check_selection(v0_same_minor v0_13 0.13.0 TRUE)
check_selection(v0_other_minor v0_13 0.14.0 FALSE)

make_package(v1_rc 1.0.0 rc.1 SameMajorVersion)
check_selection(rc_unversioned v1_rc "" TRUE)
check_selection(rc_stable_request v1_rc 1.0.0 FALSE)

make_package(v1_3 1.3.0 "" SameMajorVersion)
check_selection(v1_later_minor v1_3 1.1.0 TRUE)

make_package(v1_0 1.0.0 "" SameMajorVersion)
check_selection(v1_too_old v1_0 1.1.0 FALSE)

make_package(v2_0 2.0.0 "" SameMajorVersion)
check_selection(v1_incompatible_major v2_0 1.0.0 FALSE)
